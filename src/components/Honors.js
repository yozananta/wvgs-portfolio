    ...
    return (
        <div id="honors" className="mt-4 text-white">
            ...
            <div className="flex flex-col md:flex-row mt-4 gap-5">
                <HonorCard name="Internship at Dinas Pariwisata Kota Batu" issued="Author" desc="Maintenance and troubleshooting of the cultural database on the website https://sininja.site/ and the Cultural Database of Batu City are being conducted to ensure optimal performance and data accuracy." />
